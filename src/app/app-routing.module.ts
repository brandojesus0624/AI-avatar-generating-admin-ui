...
const routes: Routes = [
  ...
  { path: 'tasks/list/:user', component: TaskListComponent , canActivate: [AuthorizationGuard]},
  ...
  { path: 'collections/list/:user', component: ImageCollectionListComponent , canActivate: [AuthorizationGuard]},
